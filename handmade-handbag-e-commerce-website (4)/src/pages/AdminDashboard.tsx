...
import { logout, changePassword } from '../lib/useAuth';
import {
  X, LayoutDashboard, Package, Settings, Save, Trash2, Plus,
  LogOut, Lock, Check, AlertCircle, Image as ImageIcon, Upload
} from 'lucide-react';
