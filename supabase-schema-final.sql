-- SAFOS Complete Database Schema
...
CREATE POLICY "Authenticated users can manage collections" ON collections FOR ALL TO authenticated USING (true);
...
CREATE POLICY "Public can view craft steps" ON craft_steps FOR SELECT USING (true);
CREATE POLICY "Authenticated users can manage craft steps" ON craft_steps FOR ALL TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can manage store settings" ON store_settings FOR ALL TO authenticated USING (true);
